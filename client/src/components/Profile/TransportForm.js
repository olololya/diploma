...
export default class TransportForm extends Component {
    ...
    render() {
        const {isShowModalTransport, onClose} = this.props;
        const {types} = this.state;
        return (
            <Modal show={isShowModalTransport}>
                <Modal.Header>
                    <Modal.Title>Добавить транспорт</Modal.Title>
                </Modal.Header>

                <Modal.Body className="modal-transport">
                    <Row className="field-container">
                        <Col md={5}>
